        ...
        <div class="row">
            <div class="col-xl-10 col-lg-8 col-md-8 section-title">
                ...
                <a class="wow fadeInLeft mb-10 red" data-wow-delay=".6s"
                    href="/genre?g=<?php echo strtolower($review->genres[$key]["genre"]) ?>"><?php echo $review->genres[$key]["genre"] ?></a>
                <?php }
                            } else { ?>
                <a class="wow fadeInLeft mb-10 red" data-wow-delay=".6s"
                    href="/genre?g=<?php echo strtolower($review->genres[0]["genre"]) ?>"><?php echo $review->genres[0]["genre"] ?></a>
                <?php } ?>
                <div class="row">
                ...
                <a class="mb-10 mt-10" href="/type?t=0"><span class="wow fadeInLeft"
                        data-wow-delay=".2s">Movie</span></a>
                <?php else : ?>
                <a class="mb-10 mt-10" href="/type?t=1"><span class="wow fadeInLeft"
