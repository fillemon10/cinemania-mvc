        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 section-title">
                <p class="wow fadeInDown" data-wow-delay=".4s"><i
                        class="p-mask fas fa-calendar-alt"></i>&#8192;<?php echo date("F j, Y ", strtotime($post->created_at)); ?>&#8192;&#8192;<i
                        class="p-mask fas fa-user"></i>&#8192;<?php echo $post->username  ?></p>
                ...
                <a class="mb-0" href="/topic?t=<?php echo $post->topic_id ?>"> <span class="wow fadeInLeft"
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 text-right">
                <a class="mb-0" href="/post?p=<?php echo $post->slug; ?>">
                    <img class=" box-style p-0 news-img wow fadeInRight mb-0" width=10 data-wow-delay=".4s"
                        src="<?php echo $post->image ?>" alt="post-image">
                </a>
            </div>
        </div>
    </div>
