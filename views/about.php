         ...
         <div class="row">
             <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                 <div class="section-title text-center mb-55">
                     ...
                     <h2 class="">Why Chose Us?</h2>
                     <p class="">We are expert in cinema and reviews.</p>
                 </div>
             </div>
         </div>
 ...
 <!--========================= about-section start========================= -->
 <section id="about" class="pt-40 mb-150 mt-100 box-style p-0" style="overflow:hidden;">
                     ...
                     <div class="about-img-wrapper">
                         <div class="about-img position-relative d-inline-block ">
                             <?php if (strpos($_SERVER['HTTP_ACCEPT'], 'image/webp') !== false) { ?>
                                 <img src="https://res.cloudinary.com/daocxbh9k/image/upload/v1616534463/about_nb9zsn.webp" alt="cinema seats" class="" />
                             <?php } else { ?>
                                 <img src="https://res.cloudinary.com/daocxbh9k/image/upload/v1616534463/about_m06kgh.png" alt="cinema seats" class="" />
                             <?php } ?>
