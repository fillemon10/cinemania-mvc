            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 section-title">
                    ...
                    <?php if (isset($post->{'topic'})) : ?>
                        <a class="mb-0" href="/topic/<?php echo $post->{"topic_id"} ?>"> <span class=""> <?php echo $post->{'topic'} ?></span></a>
                    <?php endif ?>
                    <div class="mb-10 "><?php echo htmlspecialchars_decode($post->{"body"}) ?></div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 text-right">
                    <a class="mb-0" href="/post/<?php echo $post->{"slug"}; ?>">
                        <img class=" box-style p-0 blog-img  mb-0" src="<?php echo $post->{"image"} ?>" alt="post-image">
                    </a>
                </div>
            </div>
        </div>
