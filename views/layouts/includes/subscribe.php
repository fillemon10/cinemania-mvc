...
<div class="container pb-40">
    <section class="subscribe-section pt-70 pb-70 img-bg-subscribe" style="background-image: url('/assets/img/bg/common-bg.svg')">
        <div class=" container subscribe-container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="section-title mb-30">
                        <span class="text-white ">Subscribe</span>
                        <h2 class="text-white mb-40 ">Subscribe To Our Newsletter</h2>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
