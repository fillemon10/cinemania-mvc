...
<section id="blog" class="blog-section mt-100 pt-30 pb-20">
            ...
            <div class="row">
                <?php if (isset($post->{'published'}) == false) : ?>
                    ...
                    <div class="col-4 mt-20">
                        <a href="/blog" class="theme-btn readmore-btn"><i class="fas fa-arrow-left"></i>&#8192;Back to blog</a>
                    </div>
                <?php else : ?>
                    <div class="col-xl-8 col-lg-8 col-md-8 section-title">
                        ...
                        <?php if (isset($post->{'topic'})) : ?>
                            <a class="mb-10 mt-10" href="/genre/<?php $post->{'topic_id'}  ?>"> <span class="wow fadeInLeft" data-wow-delay=".4s"> <?php echo $post->{'topic'}  ?></span></a>
                        <?php endif ?>
